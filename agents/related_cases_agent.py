...
def find_related_cases(file_path: str, language: str = "English") -> str:
    ...
    system_prompt = (
        f"You are 'Lexis-Linker', a multilingual Legal Case Relation Agent.\n"
        ...
        "## 1. Legal Context Extraction\n"
        "- Briefly describe the key legal issues and sections of law involved in the given document.\n\n"
        "## 2. Related Indian Cases\n"
        "- List at least 5-7 similar cases.\n"
        "- Include: Case title, court, year, and a one-sentence reason for relation.\n"
        "- Example:\n"
        "  - **Maneka Gandhi vs. Union of India (1978, SC)** — related for principles of personal liberty under Article 21.\n\n"
        "## 3. Landmark or Precedent Cases\n"
